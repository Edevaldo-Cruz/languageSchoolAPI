        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Marie Dubois", "234.567.890-21", "+33 6 12 34 56 78", "Rue de l'Espoir, 456, maison 02", "marie.dubois@hotmail.fr", new DateTime(1979, 4, 20), "Feminino", "Americana", " " },
                    ...
                    { 6, "Amélie Martin", "678.901.234-65", "+33 6 23 45 67 89", "Rue des Lilas, 2222, appartement 301", "amelie.martin@hotmail.fr", new DateTime(1990, 6, 10), "Feminino", "Espanhola", " " },
                    ...
                    { 9, "Sofía Rodríguez", "999.999.999-99", "+34 912 34 56 78", "Calle de Alcalá, 987", "sofia.rodriguez@teste.com", new DateTime(1992, 8, 17),           "Feminino", "Francesa", "Observação sobre a professora Sofía Rodríguez." }
                });
        }
